    ...
    : QDockWidget(parent)
{
    ...
    btnApplyDithering = new QPushButton(tr("Apply Ordered Dithering"), dockContent);
    mainLayout->addWidget(btnApplyDithering);
    connect(btnApplyDithering, &QPushButton::clicked,
            this, &DitheringQuantizationWidget::onApplyOrderedDitheringClicked);
    ...
    QLabel *labelQuantization = new QLabel(tr("Popularity Quantization"), dockContent);
    ...
    btnApplyQuantization = new QPushButton(tr("Apply Popularity Quantization"), dockContent);
    mainLayout->addWidget(btnApplyQuantization);
    connect(btnApplyQuantization, &QPushButton::clicked,
            this, &DitheringQuantizationWidget::onApplyPopularityQuantizationClicked);
