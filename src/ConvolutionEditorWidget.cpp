...
ConvolutionEditorWidget::ConvolutionEditorWidget(QWidget *parent)
  ...
  connect(tableKernel, &QTableWidget::itemChanged, this,
          &ConvolutionEditorWidget::onTableItemChanged);
  ...
  connect(actionBlur, &QAction::triggered, this,
          &ConvolutionEditorWidget::onPresetBlurClicked);
  connect(actionGaussian, &QAction::triggered, this,
          &ConvolutionEditorWidget::onPresetGaussianClicked);
  connect(actionSharpen, &QAction::triggered, this,
          &ConvolutionEditorWidget::onPresetSharpenClicked);
  connect(actionEdge, &QAction::triggered, this,
          &ConvolutionEditorWidget::onPresetEdgeClicked);
  connect(actionEmboss, &QAction::triggered, this,
          &ConvolutionEditorWidget::onPresetEmbossClicked);
  ...
  connect(checkAutoDivisor, &QCheckBox::toggled, this,
          &ConvolutionEditorWidget::onAutoDivisorToggled);
  ...
  connect(spinRows, QOverload<int>::of(&QSpinBox::valueChanged), this,
          &ConvolutionEditorWidget::onKernelSizeChanged);
  connect(spinCols, QOverload<int>::of(&QSpinBox::valueChanged), this,
          &ConvolutionEditorWidget::onKernelSizeChanged);
  connect(btnApply, &QPushButton::clicked, this,
          &ConvolutionEditorWidget::onApplyButtonClicked);
}
