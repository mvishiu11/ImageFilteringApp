 ...
 *
 * The widget emits signals when the user clicks the corresponding apply buttons.
 */
...
signals:
     ...
     */
    void applyOrderedDitheringRequested(int thresholdMapSize, int levelsPerChannel);
...
private:
    ...
    class QComboBox *comboThresholdSize; ///< Dropdown to select threshold map size.
    ...
    class QPushButton *btnApplyQuantization; ///< Button to apply popularity quantization.
};
