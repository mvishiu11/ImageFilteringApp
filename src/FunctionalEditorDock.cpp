...
FunctionalEditorDock::FunctionalEditorDock(QWidget *parent)
    : QDockWidget(parent), m_canvas(new FunctionEditorCanvas(this)) {
  ...
  connect(btnApply, &QPushButton::clicked, this,
          &FunctionalEditorDock::onApplyClicked);
  ...
  connect(btnReset, &QPushButton::clicked, this,
          &FunctionalEditorDock::onResetClicked);
...
void FunctionalEditorDock::setInitialBrightnessCurve(int delta,
                                                     int samplePoints) {
  m_canvas->setCurveForBrightness(delta, samplePoints);
}

void FunctionalEditorDock::setInitialContrastCurve(double factor,
                                                   int samplePoints) {
...
void FunctionalEditorDock::onResetClicked() { m_canvas->resetPoints(); }
